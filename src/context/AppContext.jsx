...
export const TRANSLATIONS = {
  en: {
    ...
    home: {
      ...
      s03lede: 'Environment art, shaders and editor tools across mobile MMORPG and console titles. Currently deepening into Technical Art.',
  ...
  vi: {
    ...
    home: {
      ...
      s03lede: 'Environment art, shader và editor tool cho mobile MMORPG và console. Đang deepening vào Technical Art.',
      readBio: 'Xem thêm',
      ctaLabel: 'Liên hệ',
